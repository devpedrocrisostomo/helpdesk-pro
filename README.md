...
Este repositorio inclui uma pagina estatica em `docs/` e um workflow em `.github/workflows/pages.yml` para publicar no GitHub Pages.

Importante: GitHub Pages nao executa Java, WildFly, Docker, PostgreSQL nem rotas de API. Portanto, o Pages serve apenas como pagina publica do projeto. Para testar o sistema real, rode com Docker localmente ou publique em uma plataforma com suporte a backend/container.
